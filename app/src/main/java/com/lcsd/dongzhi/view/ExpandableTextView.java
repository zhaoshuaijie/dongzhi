...
import com.lcsd.dongzhi.util.UIUtil;
    ...
    *//*收起图片*//*
    ...
    private void init(AttributeSet attrs) {
      ...
      /*  if (mExpandDrawable == null) {
            mExpandDrawable = ContextCompat.getDrawable(getContext(),R.drawable.icon_blue_arrow_up);
        }
        if (mCollapseDrawable == null) {
            mCollapseDrawable = ContextCompat.getDrawable(getContext(), R.drawable.icon_blue_arrow_down);
        }*/
        ...
        collapseExpandTextColor = typedArray.getColor(R.styleable.ExpandableTextView_collapseExpandTextColor, ContextCompat.getColor(getContext(), R.color.blue));
