...
public class CameraActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        //设置视频保存路径
        jCameraView.setSaveVideoPath(Environment.getExternalStorageDirectory().getPath() + File.separator + "fengtai");
        ...
        jCameraView.setErrorLisenter(new ErrorListener() {
            ...
            public void AudioPermissionError() {
                Toast.makeText(CameraActivity.this, "请授予录音权限！", Toast.LENGTH_SHORT).show();
            }
        });
        //JCameraView监听
