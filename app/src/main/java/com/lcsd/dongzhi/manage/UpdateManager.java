package com.lcsd.dongzhi.manage;
...
public class UpdateManager {
                    ...
                    try {
                        ...
                        if(object.getString("status").equals("ok")){
                            ...
                            if(list!=null&&list.size()>0){
                                hashMap.put("version", list.get(0).getVersion_no());
                                hashMap.put("url", list.get(0).getVersion_url());
                                hashMap.put("name", list.get(0).getVersion_name());
                                hashMap.put("desc",list.get(0).getVersion_desc());
    ...
    private void showNoticeDialog() {
        ...
        if (0 != mHashMap.size() && mHashMap.get("desc") != null) {
            builder.setMessage(mHashMap.get("desc"));
        }
        // 更新
    ...
    private void installApk() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            Uri contentUri = FileProvider.getUriForFile(mContext, "com.lcsd.dongzhi.MyFileProvider", apkfile);
