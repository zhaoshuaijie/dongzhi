...
public enum PermissionEnum {
    ...
    READ_EXTERNAL_STORAGE(Manifest.permission.READ_EXTERNAL_STORAGE,"读取存储"),
    WRITE_EXTERNAL_STORAGE(Manifest.permission.WRITE_EXTERNAL_STORAGE,"写入存储"),
    ...
    GROUP_STORAGE(Manifest.permission_group.STORAGE,"存储");
